...
//  #endif     
 ...
 {//Cambio modo video
  ...
  switch (video)
  {
   ...
   case 6: gb_vga_videomode_cur= 6; is8colors=0; gb_ptrVideo_cur= VgaMode_vga_mode_200x150; usepllcteforce=1; p0=0x000A; p1=0x0057; p2=0x0007; p3=0x0007; usecustompll=0; break;
   case 7: gb_vga_videomode_cur= 7; is8colors=0; gb_ptrVideo_cur= VgaMode_vga_mode_200x150; usepllcteforce=0; usecustompll=1; break;
   default: break;
  }
 }//fin video!=255
