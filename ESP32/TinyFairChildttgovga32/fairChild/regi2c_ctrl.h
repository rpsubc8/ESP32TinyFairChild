...
unsigned char rom_i2c_readReg(unsigned char block, unsigned char host_id, unsigned char reg_add); //uint8_t rom_i2c_readReg(uint8_t block, uint8_t host_id, uint8_t reg_add);
unsigned char rom_i2c_readReg_Mask(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char msb, unsigned char lsb); //uint8_t rom_i2c_readReg_Mask(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t msb, uint8_t lsb);
void rom_i2c_writeReg(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char data); //void rom_i2c_writeReg(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t data);
void rom_i2c_writeReg_Mask(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char msb, unsigned char lsb, unsigned char data); //void rom_i2c_writeReg_Mask(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t msb, uint8_t lsb, uint8_t data);
...
unsigned char regi2c_ctrl_read_reg(unsigned char block, unsigned char host_id, unsigned char reg_add); //uint8_t regi2c_ctrl_read_reg(uint8_t block, uint8_t host_id, uint8_t reg_add);
unsigned char regi2c_ctrl_read_reg_mask(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char msb, unsigned char lsb); //uint8_t regi2c_ctrl_read_reg_mask(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t msb, uint8_t lsb);
void regi2c_ctrl_write_reg(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char data); //void regi2c_ctrl_write_reg(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t data);
void regi2c_ctrl_write_reg_mask(unsigned char block, unsigned char host_id, unsigned char reg_add, unsigned char msb, unsigned char lsb, unsigned char data); //void regi2c_ctrl_write_reg_mask(uint8_t block, uint8_t host_id, uint8_t reg_add, uint8_t msb, uint8_t lsb, uint8_t data);
